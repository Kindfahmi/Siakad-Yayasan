...
<div class="container" style="width: 750px; margin-left:150px;">
	<div class="row">
		...
		<table class="table table-borderless" style="text-align:center;">
			...
			<?php while ($rows = mysqli_fetch_assoc($exec)) : ?>
				<tr>
					<td><?= $rows["NIP"]; ?></td>
					<td><?= $rows["nama"]; ?></td>
					<td><a href="hapus-guru.php?NIP=<?= $rows["NIP"] ?>" style="color: white; text-decoration:none;" class="btn btn-danger btn-sm" onclick="return confirm('yakin?');">
							...
							Hapus</a>
						<a href="detail-guru.php?nip=<?= $rows["NIP"] ?>" style="color: white; text-decoration:none;" class="btn btn-primary btn-sm">
