...
<body>
  ...
  <nav class="navbar sticky-top navbar-expand-lg navbar-dark bg-primary">
    <div class="container-fluid">
      <img src="../img/yys.png" style="width: 65px; height: 65px;" alt="">
      <a class="navbar-brand nav-atas" href="index.php">
        SIAKAD YYS Attaufiqiyyah</a>
        ...
        <?php else : ?>
          ...
          <li class="nav-item">
            <a class="nav-link" href="raport-index.php">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-journal-check" viewBox="0 0 20 20">
