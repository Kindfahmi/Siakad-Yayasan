...
<head>
  ...
  <title>SIAKAD YYS Attaufiqiyyah</title>
...
<body class="d-flex h-100 text-center text-white bg-primary">
  ...
  <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
    ...
    <main class="px-3">
      <h1>SIAKAD YYS Attaufiqiyyah</h1>
      <p class="lead">SIAKAD (Sistem Informasi Akademik) YYS Attaufiqiyyah adalah suatu Sistem Informasi Akademik yang dibangun untuk memberikan kemudahan kepada pengguna dalam kegiatan administrasi akademik yayasan secara online.</p>
      <br>
