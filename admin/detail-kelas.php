            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <select class="form-select form-select-md mb-3" aria-label=".form-select-lg example" id="Kelas" name="Kelas">
                        <option value="-">-</option>
                        <option value="madin awaliyyah 1">madin awaliyyah 1</option>
                        <option value="madin awaliyyah 2">madin awaliyyah 2</option>
                        <option value="madin wustho 1">madin wustho 1</option>
                        <option value="madin wustho 2">madin wustho 2</option>
                        </optgroup>
                    </select>
                </div>
